...
class Transformer(nn.Module):
    ...
    def __init__(self,
        ...
        # self.config = TransformerConfig(**locals())
        super().__init__()
        ...
        self.lm_head = nn.Linear(self.config.n_embd, self.config.n_class, bias=True)
    ...
    def forward(self, idx, targets=None, sample_weight=None):
        device = idx.device
        b, t = idx.size()
        ...
        if targets is not None:
            ...
            if not (sample_weight is None):
                loss = torch.dot(sample_weight, F.cross_entropy(logits, targets, reduction="none"))
            else:
